    ...
    <main className="min-h-screen bg-black py-20 text-white">
      <div className="container max-w-3xl">
        ...
        <div className="mt-12 space-y-8 text-base leading-relaxed text-white/65">
          <section><h2 className="font-display text-3xl text-white">Hellweg Europe</h2><p className="mt-3">Daniel Hellweg &amp; Benjamin Hellweg<br />Auelsweg 22<br />53797 Lohmar<br />Deutschland</p></section>
